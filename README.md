...
Личный набор из **16 скиллов** для Claude Code — чтобы они были доступны не только на локальной машине, но и в облачном / мобильном Claude Code.
...
После установки все 16 скиллов доступны в любом проекте.
